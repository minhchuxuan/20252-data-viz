...
Olympic committees (of which \textbf{91} won at least one medal), \textbf{11{,}183}
athletes in the official roster --- \textbf{11{,}110} of whom (99\,\%) also carry an
\emph{enriched profile} (age, venue, dates, records) that powers the demographic and
map views --- \textbf{2{,}271} athlete--medal records, and \textbf{45} normalized
disciplines shared across views. The roster figure headlines the Opening Lens while
