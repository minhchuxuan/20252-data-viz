...
\begin{frame}{Objective and story arc}
  ...
  narrative with \teallead{exploratory} filtering --- four linked sections,
  broad to narrow:
  \vspace{6pt}
  \begin{columns}[T]
...
\begin{frame}{Reproducible by design}
  ...
  \begin{columns}[T]
    ...
    \column{0.45\textwidth}
      \teallead{Checked}
      \begin{itemize}
        \item All four sections and every control exercised, including empty and narrow selections
